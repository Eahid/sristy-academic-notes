...
export const translations: Record<string, string> = {
  ...
  "Available Archives": "টি নথি পাওয়া গেছে",
  ...
  "No archive description notes provided.": "নথি বা মালের কোনো বর্ণনা প্রদান করা হয়নি।",
  ...
  "Branch Pending Archives": "শাখার অনুমোদনের অপেক্ষমাণ আর্কাইভস",
  ...
  "My Handheld Archives / Upload History": "আমার আপলোডকৃত ফাইলসমূহ",
  ...
  "Profile created beautifully! Logging you into the archive system...": "প্রোফাইল চমৎকারভাবে তৈরি হয়েছে! সিস্টেমে লগইন করা হচ্ছে...",
  ...
  "Global Archives": "সার্বিক আর্কাইভ",
  ...
  "Currently compiling archives of": "আর্কাইভ তদারকি করছেন",
  "Currently Browsing: EVERYONE": "সার্বিক ব্রাউজিং: সবাই",
  "Currently Browsing: BRANCH ARCHIVE": "সার্বিক ব্রাউজিং: নিজ শাখা",
  "Branch Administrator Panel": "শাখা এডমিন প্যানেল",
  "Governing Body": "পরিচালনা পর্ষদ",
  "Global Archive Visibility": "বৈশ্বিক আর্কাইভ দৃশ্যমানতা",
  ...
  "Please choose or drag-and-drop a file archive first.": "দয়া করে প্রথমে একটি ফাইল নির্বাচন ও ড্র্যাগ করুন।",
  ...
  "Sristy Academic Archive Portal": "সৃষ্টি একাডেমিক আর্কাইভ পোর্টাল",
  "Teaching Department": "শিক্ষাদান বিভাগ",
  "My Submissions": "আমার জমাকৃত ফাইল",
  "Archives uploaded": "আর্কাইভ আপলোড করা হয়েছে",
  ...
  "Briefly state target topics, chapters, and summary of the archive...": "ফাইলটির বিষয়বস্তু, অধ্যায় এবং একটি সংক্ষিপ্ত বিবরণ দিন...",
  ...
  "Department": "বিভাগ",
  "Verified archives": "অনুমোদিত আর্কাইভস",
